...
// الحصول على قيمة الصف من URL
$class = isset($_GET['class']) ? $_GET['class'] : '';

// التحقق إذا كانت قيمة الصف موجودة
if ($class) {
    // جلب الفصول المتعلقة بالصف المطلوب
    $sql_class = "SELECT DISTINCT class FROM lessons WHERE class = '$class'";
    ...
    // تحويل المصفوفة إلى JSON وإرسالها إلى العميل
